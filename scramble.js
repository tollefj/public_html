...
const llmSlander = [
    ...
    "tokenization: breaking language into tiny pieces, then desperately trying to glue it back together.",
    ...
    "making predictions based on patterns, even if those patterns are misleading.",
